...
<div id="content">
   <div id="generic">
      ...
      <dl class="content">
         <dt>Our use of your data, cookies, and external services: what you should know,
             and how to opt out if you want to.</dt>
         <dd>
            Summary: We care a lot about our users’ privacy. We provide details below, 
         ...
         <dd>
            ...
            <tr><td>uuid</td><td>A random unique identifier</td><td>When web browser is closed</td></tr>
            </table>
          </dd>
          
          <dt>Measuring website usage (Google Analytics)</dt>
          <dd>
          ...
          <dt>Google’s Official Statement about Analytics Data</dt>
          <dd>
         ...
         <dt>Credits</dt>
         <dd>
         Bits of wording taken from the <a href="http://gov.uk/help/cookies">gov.uk cookies page</a> (under the Open Government Licence).
         </dd>
